...
class Solution:
    def bottomView(self, root):
        # create a dict to keep track of the bottom-most node of each column on x-axis
        ...
        while len(queue):
            for i in range(len(queue)):
                ...
                # update the bottom-most node of the current column with current node value in the location map dict
